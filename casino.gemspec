...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency 'faraday', '~> 2.7.5'
  s.add_runtime_dependency 'rotp', '~> 6.2.2'
  s.add_runtime_dependency 'grape', '~> 1.2.5'
  s.add_runtime_dependency 'grape-entity', '~> 0.10.2'
  s.add_runtime_dependency 'rqrcode_core', '~> 1.2.0'
